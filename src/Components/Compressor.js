...
import {
    faImage, faDownload, faUpload, faImage as faImagePlaceholder,
    faQuestionCircle, faHistory
...
function CompressorComp() {
    ...
    async function compressImage() {
        ...
        try {
            ...
            setCompressedLink(compressedImageUrl);
    ...
    return (
        <div className="mainContainer">
            <Navbar className="navbar justify-content-between" bg="light" variant="dark">
                <div>
                    <Navbar.Brand className="navbar-content">
                        <center>
                            <FontAwesomeIcon icon={faImage} className="icon" />
                            Image Compressor Made By Akash
                        </center>
                    </Navbar.Brand>
                </div>
                <div className="navbar-actions">
                    <FontAwesomeIcon icon={faQuestionCircle} className="help-icon" onClick={toggleHelp} />
                    <FontAwesomeIcon icon={faHistory} className="history-icon" onClick={toggleHistory} />
                </div>
            </Navbar>
